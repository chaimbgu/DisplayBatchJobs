...
} from "./builders/batchJobBuilder";
import { BatchJobDetails, BatchJobDescription } from "../src/types";
export const baseTestKit = () => {
  const mockGetBatchJobsList = ({
    data = [aBatchJobDescription()],
    isFetching = false,
  }: { data?: BatchJobDescription[]; isFetching?: boolean } = {}) => {
  ...
  const mockGetBatchJobsDetails = ({
    data = aBatchJobDetails(),
    isFetching = false,
  }: { data?: BatchJobDetails; isFetching?: boolean } = {}) => {
