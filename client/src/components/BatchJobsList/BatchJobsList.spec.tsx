...
import {getElementByTestId, baseTestKit, getNumberOfElementsWithTestId} from '../../../__tests__/BaseDriver'
...
it("should render ncorrect number rows", ()=>{
    testkit.mockGetBatchJobsList({data: [aBatchJobDescription(), aBatchJobDescription(), aBatchJobDescription()]})
    render(<BatchJobsList/>)
